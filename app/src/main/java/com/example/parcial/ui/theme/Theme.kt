...
/**
 * ParcialTheme: Función composable principal para aplicar el tema visual a la aplicación.
 * Maneja automáticamente el cambio entre tema claro/oscuro y colores dinámicos en Android 12+.
 */
@Composable
fun ParcialTheme(
